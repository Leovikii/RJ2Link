...
- **论坛信息预览**：在南+点击 RJ 号，即可查看封面、标题、声优、标签、发售日、销量和快捷入口。
- **跨站资源搜索**：在 DLsite 打开悬浮控件，即可查找对应的南+帖子和 ASMR ONE 试听页面。
- **移动端友好**：弹窗始终保持在可见区域内，南+论坛与 DLsite 搜索结果的长标题不会再触发页面或列表横向滚动。
- **更快的首次预览**：浏览器和网络空闲时，可提前加载附近作品的轻量信息。
- **夜间模式与多语言**：提供南+夜间主题，并自动支持简体中文、繁体中文和英文。
