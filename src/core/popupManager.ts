import { createApp, reactive, App, Component } from 'vue';
import { VOICELINK_CLASS, RJCODE_ATTRIBUTE } from '../config/constants';
import { getVoiceLinkTarget, isInDLSite } from '../utils/common';
import type { PopupState } from '../types';

export function createPopupManager(PopupComponent: Component) {
    ...
    const Popup = {
        ...
        click(e: MouseEvent) {
            ...
            if (popupState.rjCode !== rjCode) {
                popupState.x = centerX;
                popupState.y = centerY;
            }
        ...
        mouseenter(e: MouseEvent) {
            ...
            const rect = target.getBoundingClientRect();
            popupState.x = rect.left + rect.width / 2;
            popupState.y = rect.top + rect.height / 2;
        },
